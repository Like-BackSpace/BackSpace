                ...
                {features.map((feature, index) => (
                    <div key={index} className='w-full sm:1/2 lg:w-1/3 '>
                        <div className='flex mr-3 ml-3 mb-10  border-1 rounded-lg border-neutral-700 space-x-4'>
                            <div
                                className='flex mx-6 h-10 w-10 mt-3 bg-neutral-900 text-lime-500 justify-center items-center rounded-full'>
                                {feature.icon}
                            </div>
                            <div>
                                <h5 className='mt-3  mb-6 text-xl'>{feature.text}</h5>
